...
func (r *userR) GetMessages() MessageSlice {
	if r == nil {
		return nil
	}
	return r.Messages
...
func (r *userR) GetRooms() RoomSlice {
	if r == nil {
		return nil
	}
	return r.Rooms
...
func (o *User) Rooms(mods ...qm.QueryMod) roomQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"room_members\" on \"rooms\".\"id\" = \"room_members\".\"room_id\""),
		qm.Where("\"room_members\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadRooms(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"rooms\".\"id\", \"rooms\".\"title\", \"a\".\"user_id\""),
		qm.From("\"rooms\""),
		qm.InnerJoin("\"room_members\" as \"a\" on \"rooms\".\"id\" = \"a\".\"room_id\""),
	...
	for results.Next() {
		...
		err = results.Scan(&one.ID, &one.Title, &localJoinCol)
		if err != nil {
...
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Users's Rooms accordingly.
// Replaces o.R.Rooms with related.
// Sets related.R.Users's Rooms accordingly.
func (o *User) SetRooms(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Room) error {
	...
	removeRoomsFromUsersSlice(o, related)
	if o.R != nil {
		o.R.Rooms = nil
	}
...
func (o *User) RemoveRooms(ctx context.Context, exec boil.ContextExecutor, related ...*Room) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"room_members\" where \"user_id\" = $1 and \"room_id\" in (%s)",
...
func removeRoomsFromUsersSlice(o *User, related []*Room) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
