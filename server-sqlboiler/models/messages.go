...
var MessageWhere = struct {
	...
	RoomID whereHelpernull_Int
}{
	ID:     whereHelperint{field: "\"messages\".\"id\""},
	Text:   whereHelperstring{field: "\"messages\".\"text\""},
	UserID: whereHelpernull_Int{field: "\"messages\".\"user_id\""},
	RoomID: whereHelpernull_Int{field: "\"messages\".\"room_id\""},
}
...
var (
	messageAllColumns            = []string{"id", "text", "user_id", "room_id"}
	messageColumnsWithoutDefault = []string{"text"}
	messageColumnsWithDefault    = []string{"id", "user_id", "room_id"}
...
func (o *Message) Room(mods ...qm.QueryMod) roomQuery {
...
func (messageL) LoadRoom(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMessage interface{}, mods queries.Applicator) error {
	var slice []*Message
	var object *Message
...
// SetRoom of the message to the related item.
// Sets o.R.Room to related.
// Adds o to related.R.Messages.
func (o *Message) SetRoom(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Room) error {
	var err error
	if insert {
...
func (o *Message) RemoveRoom(ctx context.Context, exec boil.ContextExecutor, related *Room) error {
	var err error

	queries.SetScanner(&o.RoomID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("room_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}
